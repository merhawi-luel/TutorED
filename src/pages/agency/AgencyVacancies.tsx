...
export default function AgencyVacancies({
  ...
  const { getAgencyVacancies, createVacancy, closeVacancy, getVacancyApplicants } =
    useData();
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="sm:col-span-2">
              ...
              <input
                ...
                placeholder="e.g. Grade 12 Mathematics Tutor"
        ...
        {myVacancies.length === 0 ? (
          ...
          >
            ...
            <p className="text-sm text-[var(--text-secondary)]">
              No vacancies yet. Create your first one!
            </p>
          </div>
        ) : (
                ...
                <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex flex-wrap gap-x-4 gap-y-1 text-xs text-[var(--text-muted)]">
                      ...
                      <span className="flex items-center gap-1">
                        <Clock size={11} /> {vacancy.teachingMode}
                      </span>
                      <span className="flex items-center gap-1">
                        <Users size={11} /> {applicants.length} applicants
                      </span>
                      <span className="text-[var(--text-faint)]">
